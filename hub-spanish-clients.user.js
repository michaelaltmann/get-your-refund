...
javascript: (function () {
    ...
    function markClientsToIgnore() {
        ...
        formTableDataRows.forEach((row, index) => {
            ...
            var isInPerson = returnListTd.querySelectorAll('span.icon-move_to_inbox').length > 0;
            if (language.toLowerCase().trim() != 'spanish' || isInPerson || orgsToSkip.includes(org.toLowerCase())) {
